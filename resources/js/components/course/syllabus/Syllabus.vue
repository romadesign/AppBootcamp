    ...
    <div class="text-center ">
        <div class="p-2 content-syllabus" v-for="(syllabu, i) in syllabus" :key="syllabu.i">
            ...
            <div class="">
                ...
                <div class="mb-3">
                    <label for="description_syllabus" class="form-label">Descripción</label>
                    <textarea id="description_syllabus" class="form-control" v-model="syllabus[i].description_syllabus" rows="3"></textarea>
                </div>
                <!-- borrar
                <div class="p-2 content-syllabus" v-for="(subSyllabus, s) in syllabus[i].sub_syllabus" :key="subSyllabus.s">
                    <h4>sub syllabus {{ s+1 }}</h4>
                  <div class="mb-3">
                      <label for="sub_title_syllabus" class="form-label">Title</label>
                      <input type="text" id="sub_title_syllabus" class="form-control" v-model="syllabus[i].sub_syllabus[s].sub_title_syllabus" placeholder="Title">
                  </div>
                  <div class="mb-3">
                      <label for="sub_description_syllabus" class="form-label">Descripción</label>
                      <input type="text" id="sub_description_syllabus" class="form-control" v-model="syllabus[i].sub_syllabus[s].sub_description_syllabus" placeholder="Descripción">
                  </div>
                </div>
...
export default {
  ...
  //   <img height="200px" width="200px" class="preview" :src="syllabus[i].picture_syllabus">
  // </div>
}
</script>
<style scoped>
